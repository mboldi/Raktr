...
export class SignersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.configService.getConfigs().subscribe((configs) => {
      ...
      this.groupLeaderNameFormControl.setValue(
        this.getConfigValue(configs, environment.rentTeamLeaderKey)?.value,
      );

      this.firstSignerNameFormControl.setValue(
        this.getConfigValue(configs, environment.rentFirstSignerNameKey)?.value,
      );
      this.firstSignerTitleFormControl.setValue(
        this.getConfigValue(configs, environment.rentFirstSignerTitleKey)?.value,
      );

      this.secondSignerNameFormControl.setValue(
        this.getConfigValue(configs, environment.rentSecondSignerNameKey)?.value,
      );
      this.secondSignerTitleFormControl.setValue(
        this.getConfigValue(configs, environment.rentSecondSignerTitleKey)?.value,
      );
    });
  }
